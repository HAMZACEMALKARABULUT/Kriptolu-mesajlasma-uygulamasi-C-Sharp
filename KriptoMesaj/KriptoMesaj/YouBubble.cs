...
namespace KriptoMesaj
{
    public partial class YouBubble : UserControl
    {
        ...
        public Cursor KriptoMesajImageCursor
        {
            get
            {
        ...
        public Cursor KriptoMesajTextCursor
        {
            get
            {
        ...
        public delegate void KriptoMesajImageClick(object sender, EventArgs e);
        public delegate void KriptoMesajTextClick(object sender, EventArgs e);

        public event KriptoMesajImageClick OnKriptoMesajImageClick;
        public event KriptoMesajTextClick OnKriptoMesajTextClick;

        private void label1_Click(object sender, EventArgs e)
        {
            if (OnKriptoMesajTextClick != null)
            {
                OnKriptoMesajTextClick.Invoke(sender, e);
            }
        }

        private void pictureBox1_Click(object sender, EventArgs e)
        {
            if (OnKriptoMesajImageClick != null)
            {
                OnKriptoMesajImageClick.Invoke(sender, e);
            }
        }
    }
}